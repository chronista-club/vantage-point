...
pub struct AddPerformerParams {
    ...
    #[schemars(
        description = "Lane Stand 種類 (engine): 'echoes' (default、 claude) / 'codex' (OpenAI Codex CLI) / 'grok' (xAI Grok CLI) / 'shell'。"
    )]
...
pub struct FlowHandoffParams {
    ...
    #[schemars(
        description = "Lane Stand (engine): 'echoes' (default、 claude) / 'codex' / 'grok' / 'shell'。"
    )]
    #[serde(default)]
    pub stand: Option<String>,
