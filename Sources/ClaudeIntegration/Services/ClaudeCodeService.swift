    ...
    public actor ClaudeCodeService: ClaudeServiceProtocol {
        ...
        public func sendMessage(
            ...
            return try await processManager.sendRequest(
                request, defaultModel: serviceConfiguration.defaultModel)
        }
        ...
        public func streamMessage(
            ...
            return try await processManager.sendStreamingRequest(
                request, defaultModel: serviceConfiguration.defaultModel)
        }
    ...
    private actor ClaudeCodeProcessManager {
        ...
        /// リクエストを送信
        func sendRequest(_ request: ClaudeCodeRequest, defaultModel: ClaudeModel) async throws
            -> ClaudeResponse
        {
        ...
        /// ストリーミングリクエストを送信
        func sendStreamingRequest(_ request: ClaudeCodeRequest, defaultModel: ClaudeModel)
            async throws -> AsyncThrowingStream<StreamEvent, Error>
        {
            AsyncThrowingStream { continuation in
                Task {
                    do {
                        ...
                        // ストリーミングプロセスを実行
                        try await executeClaudeCLIStreaming(
                            arguments: arguments, defaultModel: defaultModel
                        ) { event in
            ...
            return try await withCheckedThrowingContinuation { continuation in
                do {
                    ...
                    if process.terminationStatus != 0 {
                        ...
                        continuation.resume(
                            throwing: ClaudeIntegrationError.customError(errorMessage))
                    } else {
        ...
        private func executeClaudeCLIStreaming(
            ...
            outputHandle.readabilityHandler = { [weak self] handle in
                    ...
                    !line.isEmpty
                {
                    ...
                    Task { [weak self] in
                        if let self = self,
                            let event = await self.parseStreamEvent(
                                from: line, defaultModel: defaultModel)
                        {
                            onEvent(event)
                        }
                    }
        ...
        /// JSONレスポンスをパース
        private func parseJSONResponse(_ jsonString: String, defaultModel: ClaudeModel) throws
            -> ClaudeResponse
        {
