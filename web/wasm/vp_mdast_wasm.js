/* @ts-self-types="./vp_mdast_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function parse_to_json(markdown) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vp_mdast_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
