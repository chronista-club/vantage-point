...
impl Hub {
    ...
    pub fn subscribe(&self) -> broadcast::Receiver<ProcessMessage> {
        self.tx.subscribe()
    }

    /// Broadcast a message to all connected clients
    pub fn broadcast(&self, msg: ProcessMessage) {
    ...
    pub fn sender(&self) -> broadcast::Sender<ProcessMessage> {
        self.tx.clone()
    }
}
...
mod tests {
    ...
    fn test_broadcast_no_receivers() {
        ...
        hub.broadcast(ProcessMessage::Ping);
    }
    ...
    fn test_broadcast_with_receiver() {
        ...
        assert!(matches!(msg, ProcessMessage::Ping));
    }
    ...
    fn test_sender() {
        ...
        sender.send(ProcessMessage::Ping).unwrap();
