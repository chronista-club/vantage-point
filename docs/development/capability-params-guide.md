# Capability Parameters 実装ガイド

## 概要

このドキュメントは、Capability Parametersの6パラメータシステムの実装と使用方法を説明します。
...
- [docs/spec/05-capability.md](../../spec/05-capability.md)
- [crates/vantage-point/src/capability/params.rs](../../crates/vantage-point/src/capability/params.rs)

## 関連ドキュメント

- [Capability 仕様書](../../spec/05-capability.md)
- [Capability Evolution 設計書](../../design/02-capability-evolution.md)
