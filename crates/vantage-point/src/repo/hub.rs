...
pub struct Hub {
    ...
    tx: broadcast::Sender<RepoMessage>,
...
impl Hub {
    ...
    pub fn subscribe(&self) -> broadcast::Receiver<RepoMessage> {
        self.tx.subscribe()
    }

    /// Broadcast a message to all connected clients
    pub fn broadcast(&self, msg: RepoMessage) {
    ...
    pub fn sender(&self) -> broadcast::Sender<RepoMessage> {
        self.tx.clone()
    }
}
...
mod tests {
    ...
    fn test_broadcast_no_receivers() {
        ...
        hub.broadcast(RepoMessage::Ping);
    }
    ...
    fn test_broadcast_with_receiver() {
        ...
        assert!(matches!(msg, RepoMessage::Ping));
    }
    ...
    fn test_sender() {
        ...
        sender.send(RepoMessage::Ping).unwrap();
