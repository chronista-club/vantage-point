# Stand Capability 仕様書

## 概要

Standに拡張可能な「能力（Capability）」システムを導入する。
...
Standはユーザーの傍らに立ち、様々な能力を発揮する。
各能力は独立しているが、Stand全体として協調動作する。

### 技術的背景

- MCPがツール拡張を解決したように、Stand能力の拡張基盤が必要
- 段階的に拡張性を高めていく設計
...
- [02-stand-capability-design.md](../design/02-stand-capability-design.md)
