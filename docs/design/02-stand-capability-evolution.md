# Stand Capability Evolution 設計書

## 概要

Stand能力の成長・進化システムの設計。JoJoスタンドのACT進化システムを参考に、段階的な能力拡張を実現する。
...
- [05-stand-capability.md](../spec/05-stand-capability.md) - Capability仕様
