...
mod tests {
    ...
    fn clear_lane_state_removes_all_six_state_files_and_is_scoped() {
        ...
        let seed = |lane: &str| {
            ...
            let rp2 = pty_slot::replay_file_path_session_in(base, "vp", lane, 2, false);
        ...
        assert!(
            !pty_slot::replay_file_path_session_in(base, "vp", "feat", 2, false).exists(),
        ...
        assert!(
            pty_slot::replay_file_path_session_in(base, "vp", "other", 2, false).exists(),
