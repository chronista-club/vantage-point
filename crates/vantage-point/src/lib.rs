...
pub mod daemon;
pub mod db;
// device_input / device_profile / roto_palette は midistage-core に切り出し済み。
// 既存の crate::device_input::* 等の参照パスを保つため再エクスポートする。
#[cfg(feature = "midi")]
pub use midistage_core::device_input;
#[cfg(feature = "midi")]
pub use midistage_core::device_profile;
pub mod discovery;
pub mod echoes;
...
pub mod resolve;
#[cfg(feature = "midi")]
pub use midistage_core::roto_palette;
pub mod screenshot;
pub mod spawn_env;
pub mod stands;
pub mod terminal;
