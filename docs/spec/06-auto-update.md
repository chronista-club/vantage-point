...
TheWorld（常駐デーモン）が更新を検知し、ユーザー確認後に自動更新・再起動を行う。
...
**詳細**:
1. TheWorld に停止リクエスト送信
2. 稼働中の Process を graceful shutdown
3. バイナリを更新
4. TheWorld を再起動
...
sequenceDiagram
    ...
    participant Conductor as TheWorld
