...
pub struct DelegateParams {
    #[schemars(
        description = "The doer lane to delegate to, as an agent address (e.g. 'agent@vantage-point/feat-api' for a sub, or 'agent@vantage-point' for the root). The doer is woken (tmux) with the task and instructed to report back via complete()."
    )]
    pub doer: String,
    #[schemars(
